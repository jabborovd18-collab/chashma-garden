...
export async function requireUser(request, ruxsatEtilganRollar = null) {
  ...
  // adminAuth() ataylab try dan TASHQARIDA chaqiriladi.
  // Ilgari u ichkarida edi va sozlama xatosi ham "token yaroqsiz"
  // bo'lib chiqardi — natijada muammo tokenda deb izlanardi,
  // aslida esa xizmat kaliti sozlanmagan bo'lardi.
